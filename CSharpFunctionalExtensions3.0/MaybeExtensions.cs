...
namespace CSharpFunctionalExtensions
{
    public static class MaybeExtensions
    {
        ...
        public static K Unwrap<T, K>(this Maybe<T> maybe, Trunc<T, K> selector, K defaultValue = default(K))
            where T : class
        {
            if (maybe.HasValue)
        ...
        public static Maybe<T> Where<T>(this Maybe<T> maybe, Trunc<T, bool> predicate)
            where T : class
        {
            if (maybe.HasNoValue)
                return null;
        ...
        public static Maybe<K> Select<T, K>(this Maybe<T> maybe, Trunc<T, K> selector)
            where T : class
            where K : class
        {
            if (maybe.HasNoValue)
        ...
        public static Maybe<K> Select<T, K>(this Maybe<T> maybe, Trunc<T, Maybe<K>> selector)
            where T : class
            where K : class
        {
            if (maybe.HasNoValue)
